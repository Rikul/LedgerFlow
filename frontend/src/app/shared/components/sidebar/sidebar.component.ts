...
@Component({
  ...
  template: `
    <nav class="h-full bg-white border-r border-gray-200 pt-4">
      <div class="space-y-1 px-3">
        ...
        <!-- Expenses -->
        <a routerLink="/expenses" routerLinkActive="active" class="sidebar-link">
          <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!-- Vendors -->
        <a routerLink="/vendors" routerLinkActive="active" class="sidebar-link">
          <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!-- Bank Reconciliation -->
        <a routerLink="/bank-reconciliation" routerLinkActive="active" class="sidebar-link">
          <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  styles: [`
    .sidebar-link {
      @apply flex items-center px-3 py-2 text-lg font-medium text-gray-700 rounded-lg hover:bg-gray-100 hover:text-gray-900 transition-colors duration-200;
    }
